...
class TransformUtils
{
	...
	public static function setTweenColorTransform(current:ColorTransform, offSet:ColorTransform, tween:ColorTransform, progress:Float):Void
	{
	...
	public static function setTweenNode(current:BoneTransform, offSet:BoneTransform, tween:BoneTransform, progress:Float):Void
	{
