...
class BaseFactory extends EventDispatcher
{
	 ...
	 */
	public function parseAssetsData(skeletonXmlPath: String, textureXmlPath: String, textureImgPath: String):SkeletonData
	{
		return this.parseData(Assets.getText(skeletonXmlPath), Assets.getText(textureXmlPath), Assets.getBitmapData(textureImgPath));
		/*
	...
	public function parseData(skeletonXml: String, textureXml: String, textureImg: BitmapData):SkeletonData {
		var xmlString: String = skeletonXml;
